...
func TestDecode(t *testing.T) {
	...
	tests := []struct {
		...
		{
			port:     194,
			payload:  "681a472787821f50490200b520fbe977844d222a3a14a89293956245cc75a9ca1bbc25ddf658542909",
			devEui:   "10CE45FFFE00C7EC",
			expected: &exampleResponse,
		},
		{
		...
		{
			port:        198,
			payload:     "00b7218f6c166fadb359ea3bdec77daff72faac81784ab263386a455d3a73592a063900b",
			expectedErr: "tag 0 for port 198 not supported",
		},
		{
			port:    200,
			payload: "681a472701d63385f8ee30c2",
			expected: Port197Payload{
				Timestamp: time.Date(2025, 5, 6, 17, 30, 15, 0, time.UTC),
				Rssi1:     helpers.Int8Ptr(-42),
				Mac1:      "3385f8ee30c2",
		...
		{
			port:        200,
			payload:     "681a472700d63385f8ee30c2",
			expectedErr: "tag 0 for port 200 not supported",
		},
		{
			port:        201,
			payload:     "681a472700d63385f8ee30c2",
			expectedErr: "tag 0 for port 201 not supported",
		},
	}
...
func TestFeatures(t *testing.T) {
	tests := []struct {
		...
		},
		{
			payload:         "87821f50490200b520fbe977844d222a3a14a89293956245cc75a9ca1bbc25ddf658542909",
			port:            192,
			allowNoFeatures: true, // GNSS is handled by solver, features are not directly set by getConfig
		},
		{
			payload:         "87821f50490200b520fbe977844d222a3a14a89293956245cc75a9ca1bbc25ddf658542909",
			port:            193,

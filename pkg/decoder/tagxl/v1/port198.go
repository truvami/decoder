...
// +------+------+-----------------------------------------------+------------+
// | 0    | 1    | version (0x00 = v1, 0x01 = v2)                | byte       |
// | 1    | 6    | mac address signal 1                          | byte[6]    |
// | 7    | 6    | mac address signal 2                          | byte[6]    |
// | 13   | 6    | mac address signal 3                          | byte[6]    |
// | 19   | 6    | mac address signal 4                          | byte[6]    |
// | 25   | 6    | mac address signal 5                          | byte[6]    |
// +------+------+-----------------------------------------------+------------+
//

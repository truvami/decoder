...
// Port 163 - BLE moving (with timestamp)
//
// +------+------+-----------------------------------------------+------------+
...
type Port163Payload struct {
	Timestamp time.Time `json:"timestamp"`
	Tag       byte      `json:"tag"`
	Moving    bool      `json:"moving"` // Always true for port 163 (moving)
...
var _ decoder.UplinkFeatureBle = &Port163Payload{}
var _ decoder.UplinkFeatureMoving = &Port163Payload{}
var _ decoder.UplinkFeatureTimestamp = &Port163Payload{}
var _ decoder.UplinkFeatureBuffered = &Port163Payload{}

func (p Port163Payload) GetBufferLevel() *uint16 {
	return nil
}

func (p Port163Payload) IsBuffered() bool {
	return time.Since(p.Timestamp) > bufferedAgeThreshold
}

func (p Port163Payload) GetTimestamp() *time.Time {
	return &p.Timestamp
}

func (p Port163Payload) GetBeacons() []decoder.Beacon {
...
// Port 163 reports a moving state.
func (p Port163Payload) IsMoving() bool {
	return true
}

	...
	tests := []struct {
		...
		},
		{
			...
			expected: Port10Payload{
				...
				Battery:             4.185,
				TTF:                 time.Duration(240) * time.Second,
				PDOP:                4.5,
				Satellites:          6,
			},
		},
		...
		{
			payload: "81fe624b04f97b74bc07d0602b67310f2131",
			port:    50,
			expected: Port50Payload{
				DutyCycle:           true,
				ConfigChangeId:      0,
		...
		{
			payload:     "8002d30ba000824ace1122671b983e0eea340b06",
			port:        51,
			autoPadding: false,
			expected: Port51Payload{
				DutyCycle:           true,
		...
		{
			payload:     "0102d30ba000824ace1122671b983e0eea340b06",
			port:        51,
			autoPadding: false,
			expected: Port51Payload{
				DutyCycle:           false,
		...
		{
			payload: "21fcbbca14fbedc7cc00cc646ea2e40f8ca01004",
			port:    51,
			expected: Port51Payload{
				DutyCycle:           false,
				ConfigChangeId:      4,
		...
		{
			payload: "155e81fe624b04f97b74bc07d0602b67310f2131",
			port:    150,
			expected: Port150Payload{
				BufferLevel:         5470,
				DutyCycle:           true,
		...
		{
			payload: "050021fcbbca14fbedc7cc00cc646ea2e40f8ca01004",
			port:    151,
			expected: Port151Payload{
				BufferLevel:         1280,
				DutyCycle:           false,

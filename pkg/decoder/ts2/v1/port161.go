...
// Port 161 - BLE moving (no timestamp)
//
// +------+------+-----------------------------------------------+------------+
...
type Port161Payload struct {
	Tag    byte    `json:"tag"`
	Moving bool    `json:"moving"` // Always true for port 161 (moving)
...
var _ decoder.UplinkFeatureBle = &Port161Payload{}
var _ decoder.UplinkFeatureMoving = &Port161Payload{}

func (p Port161Payload) GetBeacons() []decoder.Beacon {
...
// Port 161 reports a moving state.
func (p Port161Payload) IsMoving() bool {
	return true
}

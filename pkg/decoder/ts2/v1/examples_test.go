...
func TestTS2_WiFi_Port201_Timestamped(t *testing.T) {
	if logger.Logger == nil {
		logger.NewLogger()
	}
	dec := NewTS2v1Decoder(context.TODO(), solver.MockSolverV1{}, logger.Logger)
...
func TestTS2_WiFi_Port197_NoTimestamp(t *testing.T) {
	if logger.Logger == nil {
		logger.NewLogger()
	}
	dec := NewTS2v1Decoder(context.TODO(), solver.MockSolverV1{}, logger.Logger)
...
func TestTS2_WiFi_Port198_NoTimestamp(t *testing.T) {
	if logger.Logger == nil {
		logger.NewLogger()
	}
	dec := NewTS2v1Decoder(context.TODO(), solver.MockSolverV1{}, logger.Logger)
...
func TestTS2_GNSS_Port192_NoTimestamp(t *testing.T) {
	if logger.Logger == nil {
		logger.NewLogger()
	}
	...
	dec := NewTS2v1Decoder(ctx, mock, logger.Logger)
...
func TestTS2_GNSS_Port193_Moving_NoTimestamp(t *testing.T) {
	if logger.Logger == nil {
		logger.NewLogger()
	}
	ctx := context.Background()
...
func TestTS2_GNSS_Port210_Timestamped_RotationTriggered(t *testing.T) {
	if logger.Logger == nil {
		logger.NewLogger()
	}
	log := logger.Logger
	...
	for _, payload := range payloads {
		...
		dec := NewTS2v1Decoder(context.TODO(), solver.MockSolverV1{}, log, WithSolverV2(capture))
...
func TestTS2_GNSS_Port211_Timestamped_RotationTriggered(t *testing.T) {
	if logger.Logger == nil {
		logger.NewLogger()
	}
	log := logger.Logger
...
func TestTS2_WiFi_Port212_Timestamped_RotationTriggered(t *testing.T) {
	if logger.Logger == nil {
		logger.NewLogger()
	}
	dec := NewTS2v1Decoder(context.TODO(), solver.MockSolverV1{}, logger.Logger)
...
func TestTS2_WiFi_Port213_Timestamped_RotationTriggered(t *testing.T) {
	if logger.Logger == nil {
		logger.NewLogger()
	}
	dec := NewTS2v1Decoder(context.TODO(), solver.MockSolverV1{}, logger.Logger)
...
func TestTS2_GNSS_Port194_Timestamped(t *testing.T) {
	if logger.Logger == nil {
		logger.NewLogger()
	}
	log := logger.Logger
...
func TestTS2_GNSS_Port195_Timestamped(t *testing.T) {
	if logger.Logger == nil {
		logger.NewLogger()
	}
	log := logger.Logger

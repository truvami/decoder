...
func TestDecode(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expected: Port160Payload{
				...
				Rssi4:  helpers.Int8Ptr(-80),
				Mac4:   helpers.StringPtr("001122334455"),
				Rssi5:  helpers.Int8Ptr(-88),
				Mac5:   helpers.StringPtr("66778899aabb"),
				Rssi6:  helpers.Int8Ptr(-96),
				Mac6:   helpers.StringPtr("ccddeeff0011"),
			},
		},
		{
			port:    161,
	...
	for _, test := range tests {
		t.Run(fmt.Sprintf("TestPort%vWith%v", test.port, test.payload), func(t *testing.T) {
			...
			dec := NewTS2v1Decoder(ctx, solver.MockSolverV1{}, logger.Logger, opts...)
...
func TestDecodeWithNoopSolver(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(fmt.Sprintf("TestPort%vWith%v", test.port, test.payload), func(t *testing.T) {
			decoder := NewTS2v1Decoder(context.TODO(), solver.NoopSolver{}, zap.NewNop())
...
func TestValidationErrors(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(fmt.Sprintf("TestPort%vValidationWith%v", test.port, test.payload), func(t *testing.T) {
			...
			decoder := NewTS2v1Decoder(ctx, solver.MockSolverV1{}, logger.Logger)
...
func TestInvalidPort(t *testing.T) {
	...
	decoder := NewTS2v1Decoder(context.TODO(), solver.MockSolverV1{}, logger.Logger)
...
func TestFeatures(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(fmt.Sprintf("TestFeaturesWithPort%vAndPayload%v", test.port, test.payload), func(t *testing.T) {
			d := NewTS2v1Decoder(context.TODO(), solver.MockSolverV1{
...
func TestNewTS2v1DecoderWithNilSolver(t *testing.T) {
	assert.Panics(t, func() {
		NewTS2v1Decoder(context.TODO(), nil, zap.NewExample())
	}, "NewTS2v1Decoder should panic when solver is nil")
}

func TestNewTS2v1DecoderSolver(t *testing.T) {
	tests := []struct {
		port        uint8
		payload     string
		expected    any
	...
	decoder := NewTS2v1Decoder(context.TODO(), solver, zap.NewExample())
	for _, test := range tests {
